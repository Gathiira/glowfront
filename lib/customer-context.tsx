...
const mockBusinesses: Business[] = [
  {
    ...
    description:
      "Premium hair salon offering precision cuts, vibrant coloring, and modern styling in a relaxing atmosphere. Our experienced stylists stay current with the latest trends.",
    rating: 4.5,
    reviewCount: 128,
    services: [
      {
    ...
    reviews: [
      {
        ...
        clientName: "Alice W.",
        rating: 5,
        text: "Best haircut I've ever had! Sophie really listened to what I wanted.",
        date: "2026-06-10",
      },
      {
        id: "r2",
        clientName: "Tom K.",
        rating: 4,
        text: "Great barber, fair price. Will be back.",
        date: "2026-06-08",
      },
      {
        id: "r3",
        clientName: "Emma R.",
        rating: 5,
        text: "The balayage came out stunning. Highly recommend Marcus!",
        date: "2026-06-05",
      },
    ],
  },
  {
    ...
    description:
      "Luxury nail salon specializing in manicures, pedicures, and custom nail art. We use only premium products for lasting results.",
    rating: 4.8,
    reviewCount: 95,
    services: [
      {
    ...
    reviews: [
      {
        ...
        clientName: "Sarah J.",
        rating: 5,
        text: "Linda does the best gel manicures. They last 3 weeks!",
        date: "2026-06-12",
      },
      {
        id: "r5",
        clientName: "Mia T.",
        rating: 5,
        text: "The nail art here is incredible. So detailed!",
        date: "2026-06-09",
      },
    ],
  },
  {
    ...
    description:
      "Classic barbershop with a modern edge. Specializing in fades, beard trims, and hot towel shaves.",
    rating: 4.3,
    reviewCount: 210,
    services: [
      {
    ...
    reviews: [
      {
        ...
        clientName: "James W.",
        rating: 5,
        text: "Dre gives the cleanest fade in Brooklyn.",
        date: "2026-06-11",
      },
      {
        id: "r7",
        clientName: "Alex M.",
        rating: 4,
        text: "Great atmosphere, fair prices.",
        date: "2026-06-07",
      },
    ],
  },
  {
    ...
    description:
      "A peaceful retreat offering therapeutic and relaxation massages. Our licensed therapists tailor each session to your needs.",
    rating: 4.7,
    reviewCount: 167,
    services: [
      {
    ...
    reviews: [
      {
        ...
        clientName: "Lisa H.",
        rating: 5,
        text: "Nina has magic hands. I always leave feeling renewed.",
        date: "2026-06-13",
      },
      {
        id: "r9",
        clientName: "David L.",
        rating: 4,
        text: "Great deep tissue massage. Really worked out the knots.",
        date: "2026-06-06",
      },
    ],
  },
  {
    ...
    description:
      "Full-service beauty salon offering facials, makeup, waxing, and brow artistry. Your one-stop destination for self-care.",
    rating: 4.6,
    reviewCount: 143,
    services: [
      {
      ...
      },
      {
        ...
        price: 60,
        duration: 45,
        description: "Curled & lifted natural lashes",
      },
    ],
    team: [
    ...
    reviews: [
      {
        ...
        clientName: "Olivia P.",
        rating: 5,
        text: "Chloe's facials are incredible. My skin has never looked better!",
        date: "2026-06-10",
      },
      {
        id: "r11",
        clientName: "Zoe A.",
        rating: 4,
        text: "Great makeup for my wedding trial. Very professional.",
        date: "2026-06-04",
      },
    ],
  },
  {
    ...
    description:
      "Award-winning tattoo studio with a focus on custom designs. Clean, professional, and artistic.",
    rating: 4.4,
    reviewCount: 189,
    services: [
      {
    ...
    reviews: [
      {
        ...
        clientName: "Ryan K.",
        rating: 5,
        text: "Jake did my sleeve and it's a masterpiece. Book early!",
        date: "2026-06-09",
      },
      {
        id: "r13",
        clientName: "Priya S.",
        rating: 4,
        text: "Clean studio, professional staff. Love my new piercing!",
        date: "2026-06-02",
      },
    ],
  },
...
export function CustomerProvider({ children }: { children: ReactNode }) {
  ...
  const [appointments, setAppointments] =
    useState<CustomerAppointment[]>(mockAppointments)
