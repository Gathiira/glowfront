...
Cohesion: 0.07
Nodes (46): appointments, clients, segments, todayAppointment, topServices, payments, reviews, movements (+38 more)

### Community 1 - "Landing & Auth Pages"
Cohesion: 0.13
Nodes (17): fetchSection(), LandingPage(), BusinessCard(), CtaSection(), Hero(), HowItWorks(), steps, Reviews() (+9 more)
...
Cohesion: 0.07
Nodes (28): fontMono, inter, RootLayout(), CustomerFlow(), LoginFormData, loginSchema, Mode, RegisterFormData (+20 more)
...
Cohesion: 0.19
Nodes (4): cities, Footer(), Header(), PaginatedResponse
...
Cohesion: 0.15
Nodes (13): ProfileDetails(), CardAction(), CardFooter(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem() (+5 more)

### Community 16 - "Business Detail Page"
Cohesion: 0.14
Nodes (10): DAY_ORDER, MapContainer, Marker, Popup, StarRating(), TileLayer, Pagination(), PaginationProps (+2 more)
...
Cohesion: 0.29
Nodes (12): BusinessDetailPage(), formatDay(), formatTime(), extractError(), fetchBusinessBySlug(), fetchBusinessReviews(), fetchBusinessServices(), fetchBusinessStaff() (+4 more)
...
Cohesion: 0.15
Nodes (17): BrowseContent(), BusinessPage(), Browse(), BusinessWithCoords, cities, FlyTo, getBusinessCoords(), MapContainer (+9 more)
...
Cohesion: 0.42
Nodes (4): CityBrowser(), Button(), buttonVariants, Calendar()

### Community 45 - "customer.ts"
Cohesion: 0.33
Nodes (5): BusinessDto, CustomerDashboardDto, ReviewDto, ServiceDto, StaffDto

## Knowledge Gaps
- **220 isolated node(s):** `formSchema`, `FormDataType`, `Mode`, `defaultIcon`, `Location` (+215 more)
...
- **Why does `cn()` connect `Dropdown Menu` to `Dashboard Pages`, `Landing & Auth Pages`, `Root Layout & Auth`, `Dashboard Layout & Sidebar`, `page.tsx`, `header.tsx`, `Business Detail`, `OTP & Select Components`, `Field Components`, `scroll-section.tsx`, `Business Detail Page`, `Location Picker & Map`, `API Client Layer`, `Item Components`, `Input Group Components`, `Business Categories`, `Alert Components`, `Hover Card`?**
...
- **What connects `formSchema`, `FormDataType`, `Mode` to the rest of the system?**
