...
export function BookingDetailDialog({
  ...
  const [businessDetail, setBusinessDetail] =
    useState<BusinessDetailDto | null>(null)
  ...
  return (
    <Dialog open={!!booking} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh]">
        ...
        {booking && (
          <div className="space-y-6 overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:hidden">
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="mt-3 flex flex-wrap gap-4 text-sm">
                      ...
                      {businessDetail.email && (
                        <a
                          href={`mailto:${businessDetail.email}`}
                          className="flex items-center gap-1 text-muted-foreground hover:text-foreground"
                        >
                    ...
                    {businessDetail.overallRating != null && (
                      <div className="mt-2 flex items-center gap-2 text-sm">
                        ...
                        <span className="text-muted-foreground">
                          ({businessDetail.totalReviews ?? 0} reviews)
                        </span>
                      </div>
                    )}
                  </div>

                  {businessDetail.location?.latitude &&
                    businessDetail.location?.longitude && (
                      <div className="rounded-lg border p-4">
                        <h4 className="mb-3 text-sm font-semibold tracking-wide text-muted-foreground uppercase">
                          Location
                        </h4>
                        <p className="mb-2 flex items-center gap-1 text-sm text-muted-foreground">
                          ...
                          {businessDetail.location.streetAddress}
                          {businessDetail.location.city
                            ? `, ${businessDetail.location.city}`
                            : ""}
                        </p>
                        {mapReady && (
